...
public class EditorTestActivity extends AppCompatActivity {
    ...
    private void setUpEditor() {
        ...
        findViewById(R.id.action_bulleted)
                .setOnClickListener(
                        new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
        ...
        findViewById(R.id.action_color)
                .setOnClickListener(
                        new View.OnClickListener() {
                            @Override
                                        ...
                                        .show(
                                                ...
                                                new ColorPickerPopup.ColorPickerObserver() {
                                                    ...
                                                    public void onColorPicked(int color) {
                                                        ...
                                                        Toast.makeText(
                                                                        EditorTestActivity.this,
                                                                        "Picked " + hex,
                                                                        Toast.LENGTH_LONG)
                                                                .show();

                                                        editor.updateTextColor(hex);
                                                    }
                                                });
                            }
                        });
        ...
        findViewById(R.id.action_erase)
                .setOnClickListener(
                        new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
        ...
        editor.setEditorListener(
                new EditorListener() {
                    ...
                    public void onUpload(Bitmap image, String uuid) {
                        ...
                        /**
                         * TODO do your upload here from the bitmap received and all
                         * onImageUploadComplete(String url); to insert the result url to let the
                         * editor know the upload has completed
                         */
        ...
        //  String serialized = "{\"nodes\":[{\"content\":[\"\\u003cp
        // dir\\u003d\\\"ltr\\\"\\u003etextline 1 a great time and I will branch office is closed on
        ...
        // style\\u003d\\\"color:#000000;\\\"\\u003eit is not available beyond that statue in a few
        // days and then we
        ...
        // String text = "<p data-tag=\"input\" style=\"color:#000000;\">I have to do the needful
        // and send to me and my husband is in a Apple has to offer a variety is not a.</p><p
        // data-tag=\"input\" style=\"color:#000000;\">I have to go with you will be highly grateful
        // if we can get the latest</p><blockquote data-tag=\"input\" style=\"color:#000000;\">I
        // have to do the negotiation and a half years old story and I am looking forward in a few
        // days.</blockquote><p data-tag=\"input\" style=\"color:#000000;\">I have to do the needful
        // at your to the product and the other to a new job is going well and that the same old
        // stuff and a half day city is the stream and a good idea to get onboard the stream.</p>";
        editor.render(text);
        findViewById(R.id.btnRender)
                .setOnClickListener(
                        new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                ...
                                */
                                ...
                                Intent intent =
                                        new Intent(
                                                getApplicationContext(), RenderTestActivity.class);
        ...
        /**
         * Since the endusers are typing the content, it's always considered good idea to backup the
         * content every specific interval to be safe.
         *
         * <p>private final long backupInterval = 10 * 1000; Timer timer = new Timer();
         * timer.scheduleAtFixedRate(new TimerTask() { @Override public void run() { String text =
         * editor.getContentAsSerialized(); SharedPreferences.Editor preferences =
         * PreferenceManager.getDefaultSharedPreferences(getApplicationContext()).edit();
         * preferences.putString(String.format("backup-{0}", new SimpleDateFormat("dd-MM-yyyy
         * hh:mm:ss").format(new Date())), text); preferences.apply(); } }, 0, backupInterval);
         */
    }
